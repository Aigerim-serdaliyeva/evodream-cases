...
if(isset($_POST["info"])) {
  ...
  $project_name = "EvodreamMarketing (Кейсы)";
...
$block= $source.': '.$info;
$source = 'visa.evodreammarketing.com'; //Источник, Если что спрашивать у Кирилла
...
$data['UF_CRM_1463741187']="visa.evodreammarketing.com";
